...
export default function AzureIcon(props) {
  return (
    ...
    >
      <defs>
        <linearGradient id="SVGvyHrkO0J" x1="58.972%" x2="37.191%" y1="7.411%" y2="103.762%">
          <stop offset="0%" stopColor="#114a8b"></stop>
          <stop offset="100%" stopColor="#0669bc"></stop>
        </linearGradient>
        <linearGradient id="SVGifIODcVR" x1="59.719%" x2="52.691%" y1="52.313%" y2="54.864%">
        ...
        <linearGradient id="SVGkT5F7b2l" x1="37.279%" x2="62.473%" y1="4.6%" y2="99.979%">
          <stop offset="0%" stopColor="#3ccbf4"></stop>
          <stop offset="100%" stopColor="#2892df"></stop>
        </linearGradient>
      </defs>
      <path
        fill="url(#SVGvyHrkO0J)"
